...
namespace ApsNetCore.Controllers
{
    public class PessoaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdPessoa,Nome,Qtd")] Pessoa pessoa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPessoa,Nome,Qtd")] Pessoa pessoa)
        {
